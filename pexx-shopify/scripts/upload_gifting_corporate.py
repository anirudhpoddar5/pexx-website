...
FILES = [
    ("CG Bottle Cover.png", "cg-bottle-cover.png", "image/png"),
    ("CG Conf Tote Bag.png", "cg-conf-tote-bag.png", "image/png"),
    ("CG Diaries.png", "cg-diaries.png", "image/png"),
    ("CG Laptop Sleeve.png", "cg-laptop-sleeve.png", "image/png"),
    ("CG Unisex Table Set.png", "cg-unisex-table-set.png", "image/png"),
    ("CG Wine Bottle Covers.png", "cg-wine-bottle-covers.png", "image/png"),
    ("CG_Print_TableSet.png", "cg-print-tableset.png", "image/png"),
]
...
def main():
    created = []
    for src_fn, shop_fn, mime in FILES:
    ...
    for shop_fn, fid in created:
        ...
        print(f"{shop_fn}: status={node.get('fileStatus')} ready={ready} ref={ref}")
